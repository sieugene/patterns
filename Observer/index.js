{
     ...
     * изменениях.
     */
    var ConcreteSubject_1 = /** @class */ (function () {
    ...
    var ConcreteObserverA = /** @class */ (function () {
        ...
        ConcreteObserverA.prototype.update = function (subject) {
            if (subject instanceof ConcreteSubject_1 && subject.state < 3) {
    ...
    var ConcreteObserverB = /** @class */ (function () {
        ...
        ConcreteObserverB.prototype.update = function (subject) {
            if (subject instanceof ConcreteSubject_1 &&
     ...
     * Клиентский код.
     */
    var subject = new ConcreteSubject_1();
